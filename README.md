...
The annotation file is provided [[here]](./human_evaluation_annotations/human_evaluation_annotations.json). The annotation file contains a subset of results generated by contrastive decoding and contrastive search given benchmarks from different domains. The complete results of contrastive decoding and contrastive search are listed in the Table below:
